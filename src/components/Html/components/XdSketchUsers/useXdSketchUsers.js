...
import useXdSketchUsersResponsiveSize from './useXdSketchUsersResponsiveSize';
...
const useXdSketchUsers = () => {
  const [currentVariant, setCurrentVariant] = React.useState(
    variantOptions['Property1Desktop']
  );

  const breakpointsVariant = useXdSketchUsersResponsiveSize();
  ...
  let fns = { handleBtnClick, onSignupClick, setCurrentVariant };
  return { data, fns };
};

export default useXdSketchUsers;
